...
2.  **Payload (Inhalt):** Die fachliche Datenstruktur.
    *   Definiert in spezifischen Schemas wie `decision.outcome.schema.json`.
...
*   **heimlern:** Produziert `policy.decision`, `decision.outcome`, `policy.weight_adjustment`.
*   **hausKI:** Konsumiert Policies und Decisions für die Ausführung.
