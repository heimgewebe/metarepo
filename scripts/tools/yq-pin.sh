...
read_pinned_version() {
  ...
  # PRIMARY: Parse version from toolchain.versions.yml without yq dependency
  # This breaks the circular dependency and enables true bootstrapping.
  # Pattern matches setup-yq action's bootstrap approach.
  local version
