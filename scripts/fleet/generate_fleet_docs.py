...
def generate_fleet_docs(output_file: str = OUTPUT_FILE) -> None:
    ...
    content.append("")
    content.append("---")
    content.append("_Generated by scripts/fleet/generate_fleet_docs.py_")
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Generate Fleet documentation.")
    parser.add_argument(
        "--output",
        default=OUTPUT_FILE,
...
if __name__ == "__main__":
    args = parse_args()
    generate_fleet_docs(args.output)
