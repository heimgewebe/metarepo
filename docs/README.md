...
### Architecture & Vision
- [Architecture](architecture.md): System overview and component layers
- [Vision](vision.md): Guidelines and roadmap
...
### Fleet Management
- [Fleet](fleet.md): Template synchronization and fleet operations
...
- [Automation](automation.md): CI/CD and automation patterns
- [CI Reusables](ci-reusables.md): Reusable workflow patterns
- [Flows](flows.md): Workflow descriptions

### Contracts & APIs
- [Contracts](contracts.md): Schema versioning and validation
- [Contract Versioning](contract-versioning.md): Rollout process
- [Knowledge Contracts](knowledge-contracts.md): Knowledge graph contracts
- [Contracts Overview](contracts/index.md): Contract index
...
### Development
- [WGX Konzept](wgx-konzept.md): Fleet motor and commands
...
- [Use Cases](use-cases.md): Common use cases
...
- [Org Index](org-index.md): Organization structure
...
- [IDEal Blueprint](IDEal_Blueprint.md): IDE integration blueprint
...
- [actionlint Checks](checks.md): GitHub Actions linting (actionlint tool)
- [actionlint Installation](install.md): Tool installation (actionlint)
- [actionlint Usage](usage.md): Tool usage (actionlint)
